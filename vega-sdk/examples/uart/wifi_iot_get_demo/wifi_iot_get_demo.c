 ...
 ***************************************************/
/**
 @file wifi_iot_get_demo.c
 @brief Contains routines for ESP8266 wifi module http get demonstration
 */
...
void main() {
	...
	printf("\n\rWifi connected\n");
	modem_connect_remote(2,"www.google.com",80);
	modem_GET_remote(2,"/","google.com","");
	modem_GET_response();
	while(1);
}
